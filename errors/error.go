...
// to happen. If a Group of errors is empty you should return nil instead of an empty group to allow common error handling code
// that test for a nil error.
type Group struct {
	code   string
	Errors []error
	Cause  error
...
// Append returns a new instance of this group with a new error appended to it.
func (g Group) Append(err error) Group {
